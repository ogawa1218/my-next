...
export const dictionaries: Record<Locale, Dict> = {
  ja: {
    ...
    menu: {
      ...
      sets: [
        { id: "kaku-6", name: "KAKU 6", detail: "6個 ・ 1フレーバー", price: "$7.90" },
        { id: "kaku-mix-6", name: "KAKU MIX 6", detail: "6個 ・ 2フレーバー", price: "$8.90" },
        { id: "kaku-box-9", name: "KAKU BOX 9", detail: "9個 ・ 3フレーバー", price: "$12.90", featured: true },
        { id: "kaku-gift-12", name: "KAKU GIFT 12", detail: "12個 ・ 4フレーバー ・ プレミアムBOX", price: "$16.90" },
      ],
    ...
    locations: {
      ...
      cities: [
        ...
        { city: "クアラルンプール", tag: "パイロット ・ 2026", d: "ASEAN第2位の購買力。ハラル検証の拠点でもあり、家賃はシンガポールより30〜40%低い。" },
      ],
      nextLabel: "次の展開：バンコク",
      next: ["香港", "シドニーCBD"],
    },
    ...
    stores: [
      { id: "singapore-cbd", city: "シンガポール", venue: "CBD 旗艦店" },
      { id: "kuala-lumpur-suria", city: "クアラルンプール", venue: "Suria KLCC" },
    ],
    reservePage: {
      eyebrow: "Reservation",
      title: "並ばない。待たせない。",
    ...
    franchisePage: {
      eyebrow: "Franchise",
      title: "次の都市を、あなたと。",
      lead: "押し寿司 × 健康 × ラグジュアリーを、海外都市に標準化された形で展開できるブランドです。レシピ、什器、SOP、トレーニング、サプライまで、開店に必要なすべてを提供します。",
      ctaInquire: "問い合わせる",
      ...
      form: {
        ...
        budget: "投資想定",
        budgets: [
          { id: "under-300k", label: "$300K 未満" },
          { id: "300k-600k", label: "$300K – $600K" },
          { id: "600k-1m", label: "$600K – $1M" },
          { id: "over-1m", label: "$1M 以上" },
        ],
        message: "ご質問・補足",
        messageOptional: "任意",
        submit: "送信する",
  ...
  en: {
    ...
    menu: {
      ...
      sets: [
        { id: "kaku-6", name: "KAKU 6", detail: "6 pc · 1 flavour", price: "$7.90" },
        { id: "kaku-mix-6", name: "KAKU MIX 6", detail: "6 pc · 2 flavours", price: "$8.90" },
        { id: "kaku-box-9", name: "KAKU BOX 9", detail: "9 pc · 3 flavours", price: "$12.90", featured: true },
        { id: "kaku-gift-12", name: "KAKU GIFT 12", detail: "12 pc · 4 flavours · premium box", price: "$16.90" },
      ],
    ...
    stores: [
      { id: "singapore-cbd", city: "Singapore", venue: "CBD Flagship" },
      { id: "kuala-lumpur-suria", city: "Kuala Lumpur", venue: "Suria KLCC" },
    ],
    reservePage: {
      eyebrow: "Reservation",
    ...
    franchisePage: {
      ...
      lead: "KAKU is a brand built to franchise — pressed sushi, health and luxury, standardised for international cities. Recipes, fixtures, SOPs, training and supply: everything you need to open.",
  ...
  zh: {
    ...
    menu: {
      ...
      sets: [
        { id: "kaku-6", name: "KAKU 6", detail: "6 件 · 1 种风味", price: "$7.90" },
        { id: "kaku-mix-6", name: "KAKU MIX 6", detail: "6 件 · 2 种风味", price: "$8.90" },
        { id: "kaku-box-9", name: "KAKU BOX 9", detail: "9 件 · 3 种风味", price: "$12.90", featured: true },
        { id: "kaku-gift-12", name: "KAKU GIFT 12", detail: "12 件 · 4 种风味 · 高端礼盒", price: "$16.90" },
      ],
      featuredLabel: "人气第一",
    ...
    stores: [
      { id: "singapore-cbd", city: "新加坡", venue: "CBD 旗舰店" },
      { id: "kuala-lumpur-suria", city: "吉隆坡", venue: "Suria KLCC" },
    ],
    reservePage: {
      eyebrow: "Reservation",
      title: "不排队。不等待。",
    ...
    franchisePage: {
      eyebrow: "Franchise",
      title: "下一座城市，与你共启。",
      lead: "押寿司 × 健康 × 奢华，作为可标准化的国际品牌出海。配方、器具、SOP、培训与供应——开业所需，一应俱全。",
      ctaInquire: "联系我们",
      ctaEconomics: "单店经济",
